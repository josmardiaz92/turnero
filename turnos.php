	...
	<body>
        ...
        <div class="contenedor-principal">
            ...
            <header>
                ...
                <div class="marco-tablaTurnos">
                    ...
                    <div class="contenedor-tablaTurnos">
                        ...
                        <div class="columna-tablaTurnos">
                            <div class="tabla-turnosArriba">Consultorio</div>  
                ...
                <div class="contenido-derecha">
                    ...
                    <div class="contenedor-turnos">
                         ...
                         <table class="tabla-turnos" id="tabla-turnos">
                            <tr><th>Turno</th><th colspan="2">Consultorio</th></tr>
                            <?php  
                                ...
                                if(mysqli_num_rows($searchUT) != 0){
                                    ...
                                    while ($row = mysqli_fetch_assoc($searchUT)){
                                        ...
                                        if($c === 0){
                                            ...
                                            echo "<tr><td><span  class='primer-fila'>$row[turno]</span></td><td class='td-caja'><span class='caja primer-fila'>Consultorio</span></td><td class='no-caja'><span  class='primer-fila'>$row[idCaja]</span></td></tr>";
            ...
            <footer class="footer">
                ...
                <marquee class="noticias">Bienvenidos a la fundación hospital San Antonio, Nuestro placer es servirles</marquee>
